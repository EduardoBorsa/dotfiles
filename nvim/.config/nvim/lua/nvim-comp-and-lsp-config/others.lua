-- Looks like this is a bunch of different configs from different plugins
local M = {}
...
M.blankline = function(override_flag)
  local default = {
    ...
    filetype_exclude = {
      ...
      "nvchad_cheatsheet", "lsp-installer", ""
    },
...
M.luasnip = function(override_flag)
  ...
  if present then
    ...
    if override_flag then default = require("core.utils").tbl_override_req("luasnip", default) end
...
M.signature = function(override_flag)
  ...
  if present then
    ...
    if override_flag then default = require("core.utils").tbl_override_req("signature", default) end
...
M.gitsigns = function(override_flag)
  ...
  if present then
    ...
    if override_flag then default = require("core.utils").tbl_override_req("gitsigns", default) end
